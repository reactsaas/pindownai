...
export function AIBlockCreationModal({ isOpen, onOpenChange, onCreateBlock }: AIBlockCreationModalProps) {
  ...
  const handleCreate = () => {
    ...
    // Start generation process and switch to preview tab
    setIsGenerating(true)
    setActiveTab("preview")
  ...
  const canCreate = canGenerate // Allow creation as long as basic info is filled
              ...
              <div className="space-y-6 h-full flex flex-col">
                ...
                <div className="flex justify-between items-center pt-4 border-t">
                  <div className="text-xs text-muted-foreground">
                    {canGenerate ? "Ready to continue" : "Fill in the required fields to continue"}
                  </div>
